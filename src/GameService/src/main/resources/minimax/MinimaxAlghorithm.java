...
//
//public class MinimaxAlghorithm {
//
//    /**
...
//
////    @Override
//    public static Position findBestMove(GameField field, CellType side) {
...
//     */
//    private static CellType getOpponentSide(CellType side) {
...
//     */
//    private static void makeMove(GameField field, int i, int j, CellType playerSide) {
...
//     */
//    private static int minimax(GameField field, int depth, boolean isMaximizing, CellType playerSide, int alpha, int beta) {
//        final WinState winState = GameUtil.isGameOver(field);
...
//     */
//    private static int maximize(GameField field, int depth, CellType playerSide, int alpha, int beta) {
...
//     */
//    private static int minimize(GameField field, int depth, CellType playerSide, int alpha, int beta) {
...
//     *         </ul>
//     */
//    private static int evaluate(WinState state, CellType side, int depth) {
